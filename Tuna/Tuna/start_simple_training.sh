...
OUTPUT_DIR="/home/nfs/u2023-ckh/checkpoints/backdoor_cleaner_deepseek_simple"
...
echo "=============================================="
echo "🚀 开始训练 DeepSeek-Coder 6.7B（简化版）"
echo "=============================================="
echo "📁 模型: ${MODEL_PATH}"
echo "📊 训练集: ${TRAIN_FILE}"
echo "📊 验证集: ${VALID_FILE}"
...
TRAINING_PID=$!
echo $TRAINING_PID > /home/nfs/u2023-ckh/FABE/Tuna/training_simple.pid
